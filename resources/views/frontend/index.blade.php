...
@if(count($banners)>0)
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-controls-wrapper">
            ...
            <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{route('product-grids')}}" role="button" style="color: whitesmoke">Shop Now
...
@push('styles')
    <style>
        ...
        .carousel-controls-wrapper a.btn {
            position: absolute;
