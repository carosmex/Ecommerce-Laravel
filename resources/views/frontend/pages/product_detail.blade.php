...
@endsection
@section('title','Bagin || PRODUCT DETAIL')
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!--/ End Description -->
											<!-- Color -->
											@if($product_detail->colors)
												<div class="color mt-4">
													<h4>Color</h4>
													<ul>
														@foreach($product_detail->colors as $color)
															<li style="background-color: {{$color->code}}; width: 20px; height: 20px; display: inline-block; border-radius: 50%; margin-right: 5px;"></li>
														@endforeach
													</ul>
												</div>
											@endif
