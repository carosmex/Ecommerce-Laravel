...
<head>
  ...
  <style>
    @font-face {
        ...
        src: url('path/to/DejaVuSans.ttf'); /* Ensure this path is correct */
    }
    body {
        font-family: 'DejaVu Sans', sans-serif; /* Use the font */
    }
  </style>
</head>
<body>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endif --}}
        <tr>
          ...
          <th><span>₱ {{ $order->shipping ? number_format($shipping_charge[0],2) : ' N/A'}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
